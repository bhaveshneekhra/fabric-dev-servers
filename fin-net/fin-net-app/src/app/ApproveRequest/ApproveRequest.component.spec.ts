...
describe('ApproveRequestComponent', () => {
  ...
  let mockApproveRequestService;
  let mockDataService

  beforeEach(async(() => {

    mockApproveRequestService = sinon.createStubInstance(ApproveRequestService);
    mockApproveRequestService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ApproveRequestService, useValue: mockApproveRequestService },
