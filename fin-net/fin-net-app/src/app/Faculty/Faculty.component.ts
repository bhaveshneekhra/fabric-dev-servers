...
export class FacultyComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceFaculty.updateParticipant(form.get('facultyId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.facultyId) {
        formObject.facultyId = result.facultyId;
      } else {
        formObject.facultyId = null;
      }
